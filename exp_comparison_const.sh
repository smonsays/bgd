...
do
	...
	CUDA_VISIBLE_DEVICES=1 python main.py --logname discrete_permuted_mnist_10tasks_10epochs_seed${seed} --nn_arch mnist_simple_net_200width_domainlearning_1024input_10cls_1ds --test_freq 10 --seed ${seed} --permute_seed ${seed} --dataset ds_padded_permuted_mnist --num_epochs $(( 10 * 10 )) --optimizer bgd --std_init 0.01 --batch_size 128 --results_dir comparison\/perm_mnist --train_mc_iters 10 --inference_mc --test_mc_iters 10 &
